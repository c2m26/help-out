        ...
        <div id={this.props.data.id+"R"} className="card mb-3" data-toggle="collapse" href={`#collapseNeedCard${this.props.data.id}`} role="button" aria-expanded="false">
          <div className="card-body">
            <div className="card-title row">
              <div className="d-flex align-items-center col-xl-9 col-lg-8 col-md-7 col-sm-12 col-12 align-items-center">
                <h5>{this.props.data.title}</h5>
              </div>
              <div className="col-xl-3 col-lg-4 col-md-5 col-sm-12 col-12 d-flex align-items-center">
                <div data-testid="fulfillButton" className="btn btn-primary btn-sm" onClick={this.handleFulfilled}>Mark as fulfilled</div>
              </div>
            </div>
