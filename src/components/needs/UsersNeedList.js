...
export class UsersNeedList extends Component {
  ...
  render(){
    ...
    return(
      <div className="container-fluid overflow-auto" style={{height: 'calc(100vh - 58px)'}}>
        <div data-testid="rowBlock" className="row overflow-auto">
          ...
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-2" >
            ...
            <div data-testid="userFulfillments" >
              {userFulfillments}
            </div>
            </div>
